...
public class C06E39 {
    public static void main(String[] args) {
        ...
        if (leftOfTheLine(x0, y0, x1, y1, x2, y2)) {
            System.out.println("(" + x2 + ", " + y2 + ") is on the left side of on the line from (" +
                    x0 + ", " + y0 + ") to (" + x1 + ", " + y1 + ")");
            ...
            System.out.println("(" + x2 + ", " + y2 + ") is on the right side of on the line from (" +
                    x0 + ", " + y0 + ") to (" + x1 + ", " + y1 + ")");
        }
    }
